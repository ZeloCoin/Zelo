...
class CBlockHeader:
    ...
    def calc_sha256(self):
        if self.sha256 is None:
            ...
            self.randomx = uint256_from_str(randomx_hash.getPoWHash(r))
